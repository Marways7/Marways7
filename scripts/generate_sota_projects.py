...
projects = [
    {
        "name": "ECG_IdentificationX",
        "desc": "Deep Learning ST-Segment Classification\\nSystem achieving SOTA in biomedical signals.",
        "lang": "MATLAB",
        "color": "#E16737",
        "stars": "15"
    },
    {
        "name": "AiliaoX",
        "desc": "Intelligent Medical Healthcare System.\\nBridging AI and Real-world Medicine.",
        "lang": "TypeScript",
        "color": "#3178C6",
        "stars": "24"
    },
...
for i, p in enumerate(projects):
  ...
  <g transform="translate({x}, {y})" style="animation: float 6s infinite {delay}s ease-in-out;">
    ...
    <!-- Language Circle -->
    <circle cx="35" cy="{pad_h - 40}" r="6" fill="{p['color']}" style="animation: blink 4s infinite;" />
    <text x="50" y="{pad_h - 35}" class="lang-font" fill="{p['color']}">{p['lang']}</text>
    
    <!-- Star Icon -->
    <svg x="280" y="{pad_h - 52}" viewBox="0 0 16 16" width="16" height="16">
    ...
    <text x="305" y="{pad_h - 38}" class="lang-font" fill="#C9D1D9">{p['stars']}</text>
  </g>
''')
...
print("SOTA Cybernetic Projects SVG generated at assets/sota-projects.svg")
