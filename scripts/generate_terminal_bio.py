...
svg_parts.append(f'''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 {width} {height}" width="100%" height="auto">
  <defs>
    <style>
      ...
      /* Typing effect delays */
      .typing-1 {{ opacity: 0; animation: type-in 0.1s forwards 0.5s; }}
      .typing-1-out {{ opacity: 0; animation: type-in 0.1s forwards 2.0s; }}
      
      .typing-2 {{ opacity: 0; animation: type-in 0.1s forwards 3.0s; }}
      .typing-2-out {{ opacity: 0; animation: type-in 0.1s forwards 4.5s; }}
      
      .typing-3 {{ opacity: 0; animation: type-in 0.1s forwards 5.5s; }}
      .typing-3-out {{ opacity: 0; animation: type-in 0.1s forwards 7.0s; }}
      
      .typing-4 {{ opacity: 0; animation: type-in 0.1s forwards 8.0s; }}
      .typing-4-out {{ opacity: 0; animation: type-in 0.1s forwards 9.5s; }}
      ...
      .final-cursor {{
        opacity: 0;
        animation: type-in 0.1s forwards 10.5s, blink 1s step-end infinite 10.5s;
      }}
      
      /* Hide previous cursors as we move down */
      .c1 {{ animation: cursor-hide 0.1s forwards 1.8s; }}
      .c2 {{ opacity: 0; animation: type-in 0.1s forwards 1.8s, blink 1s step-end infinite 1.8s, cursor-hide 0.1s forwards 2.8s; }}
      .c3 {{ opacity: 0; animation: type-in 0.1s forwards 2.8s, blink 1s step-end infinite 2.8s, cursor-hide 0.1s forwards 4.3s; }}
      .c4 {{ opacity: 0; animation: type-in 0.1s forwards 4.3s, blink 1s step-end infinite 4.3s, cursor-hide 0.1s forwards 5.3s; }}
      .c5 {{ opacity: 0; animation: type-in 0.1s forwards 5.3s, blink 1s step-end infinite 5.3s, cursor-hide 0.1s forwards 6.8s; }}
      .c6 {{ opacity: 0; animation: type-in 0.1s forwards 6.8s, blink 1s step-end infinite 6.8s, cursor-hide 0.1s forwards 7.8s; }}
      .c7 {{ opacity: 0; animation: type-in 0.1s forwards 7.8s, blink 1s step-end infinite 7.8s, cursor-hide 0.1s forwards 9.3s; }}
